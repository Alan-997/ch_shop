...
<style>
	...
	@font-face {font-family: "iconfont";
	  src: url('static/fonts/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('static/fonts/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('static/fonts/iconfont.woff?t=1576844226174') format('woff'),
	  url('static/fonts/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('static/fonts/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
